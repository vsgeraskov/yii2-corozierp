...
<div class="container-fluid row" id="map" style="width: 100%; height: 90vh; padding: 0px; margin: 0px;">
   ...
   <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4" style="background-color: #ffffff; opacity: 0.8; height: 90vh; z-index: 1000;">
       ...
       <div class="row" style="margin: 10px;">
           <div class="col-sm-1" style="align-content: center; vertical-align: middle;"></div>
           <div class="col-sm-11">
               <a href="https://vk.com/public56011242" target="_blank"><img src="../img/social/vk2.png" alt="" style="padding: 5px;"/></a>
               <!--<a href="#"><img src="../img/social/fbsmalcolor.png" alt="" style="padding: 5px;"/>-->
               <!--<img src="../img/social/googleplus.png" alt="" />-->
               <a href="https://twitter.com/corozi_perm/" target="_blank"><img src="../img/social/twitter.png" alt="" style="padding: 5px;"/></a>
               <!--<img src="../img/social/linkedin.png" alt="" />-->
               <a href="https://www.instagram.com/corozi/" target="_blank"><img src="../img/social/instagramsmalcolor.png" alt="" style="padding: 5px;"/></a>
               <a href="https://запискикоррозиониста.рф/" target="_blank"><img src="../img/social/livejournal3.png" alt="" style="padding: 5px;"/></a>
               <a href="https://www.youtube.com/channel/UCuvvWkLQb745c6QHw4NuHmw" target="_blank"><img src="../img/social/youtube3.png" alt="" style="padding: 5px;"/></a>
           </div>
       </div>
   </div>
</div>